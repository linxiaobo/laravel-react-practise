...
import { completeTask, removeTask } from "./todoSlice.jsx";
        ...
        <div className="todo-list-container">
            {todoList.map((todo) => (
                <div key={todo.id} className="todo-container">
                    ...
                    <button type="button" onClick={() => {dispatch(completeTask(todo))}}
                    ...
                    <button type="button" onClick={() => {dispatch(removeTask(todo))}}
